...
This means that a closure has access to variables and parameters
...
console.log(outerFn(5)); // 15

// callback function

/*
A callback function in JavaScript is a function that is passed
as an argument to another function and is executed after
some asynchronous operation.

Callback functions are commonly used in event handling,
AJAX requests, and asynchronous programming.
*/
...
// HOF is a function, it's take one or more fn as argument
// and it may return fn
