...
function fibonacciRec(n, memo = {}) {
  ...
  memo[n] =
    fibonacciRec(n - 1, memo) +
    fibonacciRec(n - 2, memo);
...
console.log(powRec(2, 4), Math.pow(2, 4)); // 16 16
console.log(powRec(3, 3), Math.pow(3, 3)); // 27 27
...
console.log(isPowerRec(2, 16)); // true
